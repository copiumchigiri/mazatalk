...
/// the playground (Level 7 runs later), so a generic toy icon is used.
class CountTheFriendsLevel extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final numberChoices = {target}
      ..addAll(List.generate(5, (i) => i + 1).where((n) => n != target));
    ...
    return Column(
      ...
      children: [
        const MazaSpeechBubble(text: 'Хэдэн хонь байна вэ?'),
        ...
        Wrap(
          ...
          children: List.generate(
            ...
            (i) => PlayArt(
              key: Key('sheep_$i'),
              name: 'sheep',
              placeholder: const SheepPainter(),
              width: 68,
              height: 56,
            ),
          ),
